<!-- about us -->
<section class="jumbotron-flora teal lighten-4">
    <div class="container">
        <div class="row">
            <div data-aos="fade-up" data-aos-duration="2000" class="col l12 m12 s12">
                <h1 class="center-align" style="text-transform: capitalized;"><?=ucfirst($subtitle) ;?></h1>
                <p class="center-align">Menyediakan artikel flora diantaranya adalah informasi flora, mengetahui jenis flora yang sangat banyak dan beragam tersebar di seluruh muka bumi. Baik di darat maupun di laut.</p>
