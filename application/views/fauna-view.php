<!-- about us -->
<section class="jumbotron-fauna teal lighten-4">
    <div class="container">
        <div class="row">
            <div data-aos="fade-up" data-aos-duration="2000" class="col l12 m12 s12">
                <h1 class="center-align">Kategori Fauna</h1>
                <p class="center-align light">Menyediakan artikel fauna diantaranya adalah informasi fauna, mengetahui jenis fauna yang sangat banyak dan beragam tersebar di seluruh muka bumi. Baik di darat maupun di laut.</p>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col l12 m12 s12">
                <div class="center">
                    <div data-aos="fade-up" data-aos-duration="2000" class="pagination-fauna">
